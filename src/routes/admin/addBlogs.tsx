...
import { ArrowLeft, File as FileIcon, ImagePlus, Loader2, LogOut, Save, X } from "lucide-react";
import {
  Select,
  SelectContent,
  SelectItem,
...
export const Route = createFileRoute("/admin/addBlogs")({
...
function BlogManager() {
  ...
  const attachmentDisplayName = attachmentFile?.name ?? null;
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="mx-auto max-w-7xl px-6 py-12 sm:py-16">
        <div className="space-y-3 rounded-lg border border-border bg-card p-6  sm:p-8 mb-8">
          <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            <div>
              <p className="text-sm font-medium capitalize tracking-[0.2em] text-primary">
                Blog Manager
              </p>
              <h1 className="mt-3 text-3xl font-semibold sm:text-4xl">Publish a new post</h1>
            </div>
          </div>
        </div>
                ...
                <form onSubmit={handleSave} className="space-y-6">
                    ...
                    {displayedCover && (
                      <div className="relative mt-2 inline-block">
                        ...
                        <button
                          ...
                          className="absolute -right-2 -top-2 rounded-full bg-destructive p-1 text-destructive-foreground  hover:opacity-90"
                  ...
                  <div className="space-y-2">
                    ...
                    {hasAttachment && attachmentDisplayName && (
                      <div className="flex items-center justify-between gap-3 rounded-md border border-border bg-muted px-4 py-2.5 text-sm">
                        <span className="flex min-w-0 items-center gap-3">
                          {attachmentPreviewUrl ? (
                            ...
                            <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-sm border border-border bg-background">
          ...
          <aside className="space-y-6">
            <Card className="border-border bg-card p-6">
              <CardHeader>
                ...
                <CardDescription>How the cover image will look.</CardDescription>
              </CardHeader>
              <CardContent>
                {displayedCover ? (
                  <img
                  ...
                  <div className="grid h-52 place-items-center rounded-lg border border-dashed border-border bg-muted text-sm text-muted-foreground">
